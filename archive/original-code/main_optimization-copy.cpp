...
AnalysisResult analyzePointsOptimizedStatic(const vector<Point>& points, double (*distFunc)(const Point&, const Point&)) {
    int n = points.size();
    int max_threads = omp_get_max_threads();
    
    vector<double> localMin(n * max_threads, numeric_limits<double>::max());
    ...
    for (int i = 0; i < n; ++i) {
        double finalMin = numeric_limits<double>::max();
        double finalMax = 0.0;
...
// Optimized Algorithm with DYNAMIC scheduling
AnalysisResult analyzePointsOptimizedDynamic(const vector<Point>& points, double (*distFunc)(const Point&, const Point&)) {
    int n = points.size();
    int max_threads = omp_get_max_threads();
...
AnalysisResult analyzePointsOptimizedGuided(const vector<Point>& points, double (*distFunc)(const Point&, const Point&)) {
    int n = points.size();
    int max_threads = omp_get_max_threads();
...
int main() {
    ...
    cout << "\n=== Data loaded: " << data.size() << " points ===" << endl;
    ...
    cout << "Standard distance: " << calcDist(pA, pB) << " (expected: 0.8)" << endl;
    cout << "Wraparound distance: " << calcDistWrap(pA, pB) << " (expected: 0.2)" << endl;

    cout << "PART 1: Naive Algorithm (Parallelized)" << endl;
    ...
    cout << "\n[Standard Geometry]" << endl;
    cout << "  Average nearest distance: " << resStd.avgNearest << endl;
    cout << "  Average furthest distance: " << resStd.avgFurthest << endl;
    ...
    cout << "\n[Wraparound Geometry]" << endl;
    cout << "  Average nearest distance: " << resWrap.avgNearest << endl;
    cout << "  Average furthest distance: " << resWrap.avgFurthest << endl;
    cout << "  Time taken: " << diff.count() << " seconds" << endl;
    ...
    cout << "PART 2: Optimized Algorithm" << endl;
    cout << "Testing different scheduling strategies..." << endl;

    // Test with Standard Geometry
    cout << "\n--- Standard Geometry (Optimized) ---" << endl;

    // Static
    cout << "\n[STATIC Scheduling]" << endl;
    start = chrono::high_resolution_clock::now();
    AnalysisResult optStatic = analyzePointsOptimizedStatic(data, calcDist);
    end = chrono::high_resolution_clock::now();
    diff = end - start;
    cout << "  Average nearest distance: " << optStatic.avgNearest << endl;
    cout << "  Average furthest distance: " << optStatic.avgFurthest << endl;
    cout << "  Time taken: " << diff.count() << " seconds" << endl;

    // Dynamic
    cout << "\n[DYNAMIC Scheduling]" << endl;
    start = chrono::high_resolution_clock::now();
    AnalysisResult optDynamic = analyzePointsOptimizedDynamic(data, calcDist);
    end = chrono::high_resolution_clock::now();
    diff = end - start;
    cout << "  Average nearest distance: " << optDynamic.avgNearest << endl;
    cout << "  Average furthest distance: " << optDynamic.avgFurthest << endl;
    cout << "  Time taken: " << diff.count() << " seconds" << endl;

    // Guided
    cout << "\n[GUIDED Scheduling]" << endl;
    start = chrono::high_resolution_clock::now();
    AnalysisResult optGuided = analyzePointsOptimizedGuided(data, calcDist);
    end = chrono::high_resolution_clock::now();
    diff = end - start;
    cout << "  Average nearest distance: " << optGuided.avgNearest << endl;
    cout << "  Average furthest distance: " << optGuided.avgFurthest << endl;
    cout << "  Time taken: " << diff.count() << " seconds" << endl;

    cout << "\n--- Wraparound Geometry (Optimized) ---" << endl;

    cout << "\n[STATIC Scheduling]" << endl;
    start = chrono::high_resolution_clock::now();
    optStatic = analyzePointsOptimizedStatic(data, calcDistWrap);
    end = chrono::high_resolution_clock::now();
    diff = end - start;
    cout << "  Average nearest distance: " << optStatic.avgNearest << endl;
    cout << "  Average furthest distance: " << optStatic.avgFurthest << endl;
    ...
    cout << "\n[DYNAMIC Scheduling]" << endl;
    start = chrono::high_resolution_clock::now();
    optDynamic = analyzePointsOptimizedDynamic(data, calcDistWrap);
    end = chrono::high_resolution_clock::now();
    diff = end - start;
    cout << "  Average nearest distance: " << optDynamic.avgNearest << endl;
    cout << "  Average furthest distance: " << optDynamic.avgFurthest << endl;
    ...
    cout << "\n[GUIDED Scheduling]" << endl;
    start = chrono::high_resolution_clock::now();
    optGuided = analyzePointsOptimizedGuided(data, calcDistWrap);
    end = chrono::high_resolution_clock::now();
    diff = end - start;
    cout << "  Average nearest distance: " << optGuided.avgNearest << endl;
    cout << "  Average furthest distance: " << optGuided.avgFurthest << endl;
